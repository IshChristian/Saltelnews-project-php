<footer class="footer-area">
        ...
        <div class="footer-logo mb-100">
            <a href="index.html"><h1 class="align-left">Saltel<span class="text-danger">News</span> </h1></a>
        </div>
        <!-- Footer Content -->
        <div class="container">
            <div class="row">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Saltel Company by developed with <a href="https://www.instagram.com/ish_christian200?igsh=ZGUzMzM3NWJiOQ==" target="_blank">IshChristian</a>
