      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form action="message.php?uid=<?php echo $rid ?>&sid=<?php echo $sid ?>&mid=<?php echo $mid ?>" method="post" class="msger-inputarea">
          ...
          <?php
            ...
            if (isset($_POST['btn'])) {
                ...
                if($sql){
                  echo "<script>window.location = 'message.php?uid=$rid&sid=$sid&mid=$mid'; </script>";
                }else{
